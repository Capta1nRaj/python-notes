...
# Just like family members have name, age, and roles (e.g., father is the breadwinner, child is a student), objects in OOP have attributes that define them.
...
#* 9.2. Efficiency
# Avoid duplicating code by using shared methods and attributes.

#* 9.3. Organization
# Create logical class hierarchies, making code easier to manage and understand.

#! 10. Explanation of Inheritance with Car and Bike Classes:
#* 10.1. Vehicle Class (Parent Class)
# The Vehicle class is the parent class containing common attributes like wheels and engine shared by all vehicles.

#* 10.2. Car Class (Child Class)
# The Car class inherits from the Vehicle class and adds specific features like doors and trunk, making it unique to cars.
...
# A class inherits from only one parent class, following a single line of hierarchy.
# Example: Common in Java.
...
# Parent class definition
class Animal:
    def __init__(self, name, danger):    # Constructor to initialize name and danger attributes
        self.name = name                 # Set the name attribute
        self.danger = danger             # Set the danger attribute

    def iSDanger(self):                  # Method to display if the animal is dangerous or not
        print(f"{self.name} is a {self.danger} animal.")

    def speak(self):                     # Generic sound method in the parent class
        print("Animal is making a sound")  # Default sound for any generic animal

# Child class definition that inherits from Animal
class Dog(Animal):
    def __init__(self, name, danger, color):  # Constructor to accept name, danger, and color
        super().__init__(name, danger)        # Call the parent class's constructor to set name and danger
        self.color = color                    # Set the color attribute specific to Dog

    def speak(self):                          # Overriding the 'speak' method from the parent class
        print("Dog is barking")               # Custom behavior for Dog

    def animalColor(self):                    # Method to display the color of the dog
        print(f"Dog is {self.color} color.")         # Print the color attribute
